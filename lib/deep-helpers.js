...
define(function (require) { // jshint ignore:line
  ...
  deepExtendCouple = function(destination, source, maxDepth) {
    ...
    recurse = function(key) {
      return source[key] = deepExtendCouple(destination[key], source[key], maxDepth - 1); // jshint ignore: line
    };
    ...
    combine = function(key) {
      return source[key] = _.union(destination[key], source[key]); // jshint ignore: line
    };
  ...
  deepExtend = function() {
    ...
    objects = 2 <= arguments.length
      ? __slice.call(arguments, 0, _i = arguments.length - 1)
      : (_i = 0, []), maxDepth = arguments[_i++];
